...
- Public files must contain final user-facing documentation only. Do not publish private labels, working notes, transition notes, discarded directions, revision history, short-lived identifiers, private commentary, or language describing how the artifact was made.
