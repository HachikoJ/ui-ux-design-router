...
- Public files must contain final user-facing documentation only. Do not publish internal test labels, working notes, migration commentary, discarded directions, revision history, short-lived identifiers, private commentary, or language describing how the artifact was made.
- Treat process-only labels and notes as release blockers unless they are necessary, user-facing design rationale in a project `DESIGN.md`.
